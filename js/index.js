...
var Cell, CharacterBase, CharacterPalletManager, EnemyBase, ExpManager, FieldLifeManager, FieldManager, GameManager, HondaMio, HondaMioBase, InfoManager, Keruberosu, KeruberosuBase, LeftInfoManager, LevelupController, LevelupManager, LevelupPanel, MenuManager, ObjectBase, Panel, RightInfoManager, ShibuyaRin, ShibuyaRinBase, SimamuraUduki, SimamuraUdukiBase, Utl,
...
ExpManager = (function() {
  ...
  ExpManager.increaseExp = function(amount) {
    this.expAmount += amount;
    return this.expAmount;
  };

  ExpManager.decreaseExp = function(amount) {
    if (this.expAmount < amount) {
      return false;
    }
    this.expAmount -= amount;
    return this.expAmount;
...
LevelupController = (function() {
  ...
  LevelupController.prototype.onLevelup = function() {
    ...
    levelup = Number(this.input.val());
    neededExp = this.parentLevelupPanel.object.getNeededExp(levelup);
    if (ExpManager.decreaseExp(neededExp) === false) {
      return;
    }
