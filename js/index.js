...
var Cell, Const, Game, Utl;

Cell = (function() {
  Cell.prototype.TYPE_ID = {
    NONE: 0,
    CHARACTER: 1,
    ENEMY: 2
  };
  ...
  function Cell(typeId, id) {
    ...
    initElements();
    switch (this.typeId) {
      case this.TYPE_ID.NONE:
        this.initNone();
        break;
      case this.TYPE_ID.CHARACTER:
        this.initCharacter();
        break;
      case this.TYPE_ID.ENEMY:
        this.initEnemy();
    }
  }

  Cell.prototype.initNone = function() {
    return this.images = Const.CELL.IMAGE.NONE[Utl.rand(0, Const.CELL.IMAGE.NONE.length - 1)];
  };

  Cell.prototype.initCharacter = function() {};

  Cell.prototype.initEnemy = function() {};

  Cell.prototype.initElements = function() {
    return this.elements.base = $('<img>');
  };

  Cell.prototype.changeBase = function(path) {
    return this.elements.base.attr('src', path);
  };

  Cell.prototype.plusBase = function() {
    this.imageIndex++;
    if (this.imageIndex <= this.imageIndex) {
      this.imageIndex = 0;
    }
    return this.changeBase(this.images[this.imageIndex]);
  };
...
Game = (function() {
  ...
  Game.initCharacters = function() {
    ...
    return window.characters = void 0;
  };
    ...
    for (x = j = 0, ref = Const.FIELD.SIZE.X; 0 <= ref ? j < ref : j > ref; x = 0 <= ref ? ++j : --j) {
      ...
      results.push((function() {
        ...
        for (y = l = 0, ref1 = Const.FIELD.SIZE.Y; 0 <= ref1 ? l < ref1 : l > ref1; y = 0 <= ref1 ? ++l : --l) {
          results1.push(this.field[x][y] = null);
        }
        return results1;
      }).call(this));
    }
