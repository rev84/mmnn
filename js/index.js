...
var Akui, AkuiBase, Cell, CharacterBase, CharacterPalletManager, EnemyBase, ExpManager, FieldManager, GameManager, Matsuiyamate, MatsuiyamateBase, MenuManager, ObjectBase, Panel, Revot, RevotBase, Syamugame, SyamugameBase, Utl,
...
ObjectBase = (function() {
  ...
  ObjectBase.knockout = function(hp, attack, def) {
...
Cell = (function() {
  ...
  Cell.prototype.tryAttack = function(evt) {
    ...
    def = attack === ObjectBase.ATTACK_TYPE.PHYSIC ? this.object.getPDef() : this.object.getMDef();
    hp = this.object.getHp();
    damage = this.ObjectBase.getDamage(attack, def);
    if (hp <= damage) {
      this.object.hp = 0;
      return ExpManager.plusAmount;
    } else {
      return this.object.hp -= damage;
    }
  };
  ...
  Cell.prototype.drawAttackable = function() {
    if (this.attackable) {
      return this.changeAttackable(this.attackable);
    } else {
      return this.showAttackable(false);
    }
  };
...
FieldManager = (function() {
  ...
  FieldManager.removeAllAttackable = function() {
    return $.each(this.cells, function() {
      return $.each(this, function() {
  ...
  FieldManager.drawAttackable = function() {
    return $.each(this.cells, function() {
      return $.each(this, function() {
        return this.drawAttackable();
      });
    });
  };
...
GameManager = (function() {
  ...
  GameManager.initExp = function(savedata) {
    ...
    return FieldManager.init(this.gameElement, 0, 0);
  };
  ...
  GameManager.movePick = function(cell) {
    var allCellChecked, attackableCell, attackables, body, j, l, len, len1, len2, len3, len4, len5, movableMap, o, q, r, ref, ref1, ref2, ref3, ref4, s, wayStack, x, xPlus, y, yPlus;
    ...
    for (s = 0, len5 = attackables.length; s < len5; s++) {
      attackableCell = attackables[s];
      attackableCell.attackable = [cell.object.getAttackType(), cell.object.getAttack()];
    }
    FieldManager.drawMovable();
    return FieldManager.drawAttackable();
  };
