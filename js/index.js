...
BattleResultManager = (function() {
  class BattleResultManager {
    ...
    // HPを減らす演出
    static animate(characterObject, enemyObject, isCharacterOffence, hpMax, hpBase, hpTo, callback = null) {
      ...
      return setTimeout(() => {
        ...
        decrease = (restTime, nowRate, decreaseRate) => {
          ...
          if (restTime > 0) {
            return setTimeout(decrease.bind(this, restTime, nowRate, decreaseRate), 1 / this.ANIMATION_DECREASE_FPS);
          } else {
            return setTimeout(() => {
            ...
            }, this.ANIMATION_WAIT_AFTER_MSEC);
          }
        };
        return decrease(restTime, nowRate, decreaseRate);
      }, this.ANIMATION_WAIT_BEFORE_MSEC);
    }
...
Cell = (function() {
  class Cell {
    ...
    startAnimation(imagePath, startMsec, endMsec, callback = null) {
      ...
      return setTimeout(() => {
        this.elements.animation.css('background-image', 'none').addClass('no_display');
        if (callback instanceof Function) {
          return callback();
        }
      }, endMsec);
    ...
    showPopover(text = null, msec = null, callback = null) {
      ...
      if (text === null) {
        ...
        if (msec === null) {
          ...
          return setTimeout(() => {
            $(this.elements.mother).popover('destroy');
            if (callback instanceof Function) {
              return callback();
            }
          }, msec);
...
// 若林智香
Character201 = class Character201 extends Character201Base {
  constructor(params) {
    super(params);
  }
...
// 脇山珠美
Character202 = class Character202 extends Character202Base {
  constructor(params) {
    super(params);
  }
...
// 和久井留美
Character203 = class Character203 extends Character203Base {
  constructor(params) {
    super(params);
  }
...
// 千川ちひろ
Character204 = class Character204 extends Character204Base {
  constructor(params) {
    super(params);
  }
...
FieldManager = (function() {
  class FieldManager {
    ...
    static moveObject(startCell, endCell, callback = null) {
    ...
    static randomEnemyAppear(callback = null) {
    ...
    static checkDeath(callback = null) {
...
// アニメーション登録
    ...
    static init() {
      ...
      }).on('mouseleave', this.onMouseLeave.bind(this)).css({
        width: 1200,
        height: 800
      });
      this.initField(null);
...
// 移動可能判定
    ...
    static enemyMove() {
      ...
      FieldManager.moveObject(enemyCell, moveToCell, () => {
        ...
        if (atkCell === null) {
          ...
          moveToCell.drawFin();
          return setTimeout(this.enemyMove.bind(this), 1);
        // 自爆する
        } else if (atkCell === -1) {
          return this.terror(moveToCell, this.enemyMove.bind(this));
        } else {
          // 攻撃する
          return this.attack(moveToCell, atkCell, this.enemyMove.bind(this));
        }
      });
      return true;
    }

    static attack(attackerCell, defenderCell, callback = null) {
      ...
      return setTimeout(() => {
        ...
        return BattleResultManager.animate(character, enemy, isCharacterOffence, hpMax, hpBase, hpTo, () => {
          // ダメージを与える
          defender.damage(damage);
          // 倒したキャラの台詞チェック
          return FieldManager.checkDeath(() => {
            // 攻撃側を行動終了にする
    ...
    // 自爆
    static terror(cell, callback = null) {
      // ライフを1下げる
...
PresentboxBase = class PresentboxBase extends ObjectBase {
  constructor(params) {
