...
var Cell, CharacterBase, CharacterPalletManager, EnemyBase, ExpManager, FieldLifeManager, FieldManager, GameManager, InfoManager, Keruberosu, KeruberosuBase, LeftInfoManager, MenuManager, ObjectBase, Panel, Revot, RevotBase, RightInfoManager, SimamuraUduki, SimamuraUdukiBase, Syamugame, SyamugameBase, Utl,
...
FieldManager = (function() {
  ...
  FieldManager.CELL_X = 19;

  FieldManager.CELL_Y = 9;
...
GameManager = (function() {
  ...
  GameManager.initEnemys = function(savedata) {
    ...
    return FieldManager.cells[5][5].object = new Keruberosu({
      level: 1,
      hp: null,
      inField: false,
      moved: false
...
KeruberosuBase = (function(superClass) {
  ...
  KeruberosuBase.characterName = "ケルベロス";
  ...
  KeruberosuBase.attackBase = 5;

  KeruberosuBase.hpBase = 14;

  KeruberosuBase.pDefBase = 4;
