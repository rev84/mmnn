...
var Akui, AkuiBase, Cell, CharacterBase, CharacterPalletManager, EnemyBase, ExpManager, FieldManager, GameManager, InfoManager, LeftInfoManager, Matsuiyamate, MatsuiyamateBase, MenuManager, ObjectBase, Panel, Revot, RevotBase, RightInfoManager, Syamugame, SyamugameBase, Utl,
...
Cell = (function() {
  ...
  Cell.prototype.tryAttack = function(evt) {
    ...
    if (this.object.damage(damage) <= 0) {
      ExpManager.plusAmount(this.getExp());
      this.object = null;
    }
    this.knockout.object.setMoved(true);
    this.knockout.draw();
    this.draw();
...
GameManager = (function() {
  ...
  GameManager.initExp = function(savedata) {
    ...
    return ExpManager.init(this.gameElement, 0, 0);
  };
